...
class EventsData {
	public static var defaultEventsList:Array<String> = ["HScript Call", "Camera Movement", "Add Camera Zoom", "Camera Modulo Change", "Camera Flash", "BPM Change", "Scroll Speed Change", "Alt Animation Toggle", "Play Animation", "blackall", "Set Camera Zoom", "addText", "Cinematics Bars", "backdrop"];
	public static var defaultEventsParams:Map<String, Array<EventParamInfo>> = [
		...
		"Set Camera Zoom" => [
			{name: "Value", type: TFloat(0, 9, 0.01, 9), defValue: 1.05}
		],
		"backdrop" => [
			{name: "Visible", type: TBool, defValue: false}
		],
		"Cinematics Bars" => [
			{name: "Active", type: TBool, defValue: true}, 
			{name: "Time", type: TFloat(0, 9, 0.01, 9), defValue: 0.2}
		],
		"blackall" => [
			{name: "Tween", type: TBool, defValue: false},
			{name: "Enable", type: TBool, defValue: false}, 
		],
		"addText" => [
			{name: "mftext", type: TString, defValue: ""}, 
			{name: "fantastiktext", type: TString, defValue: ""}
		],
